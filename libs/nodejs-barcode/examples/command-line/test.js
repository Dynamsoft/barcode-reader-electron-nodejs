...
async function decodeFileSync(fileName) {
  console.log('js: decode file sync')
  msg = await decodeFileResolved(fileName).catch(err => console.error(err))
  console.log('======================================')
  let result = null;
    for (index in msg) {
      result = msg[index];
